...
public class ProductController extends HttpServlet {
	...
	private String extractfilename(Part file)
	{
		...
		System.out.println(cd); // form-data; name="product-image"; filename="tshirt1.jpg"
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equalsIgnoreCase("add product"))
		{
			...
			String savepath = "E:\\TOPS\\JAVA\\EcommerceWebProject\\src\\main\\webapp\\product_images";
			...
			String savePath2 = "E:\\\\TOPS\\\\JAVA\\\\EcommerceWebProject\\\\src\\\\main\\\\webapp\\\\product_images";
			...
			request.setAttribute("msg", "Product added succefully");
			request.getRequestDispatcher("seller-product-add.jsp").forward(request, response);
		}
		...
		{	
			...
			request.setAttribute("msg", "Product updated succefully");
