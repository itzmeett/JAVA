													...
													<div class="product-fade-wrap">
														...
														<div class="product-fade-ct">
                                                            <div class="product-fade-control">
                                                                ...
                                                                <a style="margin-right:10px;" href="seller-product-edit.jsp?pid=<%=p.getPid() %>" class="btn btn-to-cart"><span>Edit</span><div class="clearfix"></div></a>
                                                                <a href="seller-product-delete.jsp?pid=<%=p.getPid() %>" class="btn btn-to-cart"><span>Delete</span><div class="clearfix"></div></a>
                                                            </div>
														</div>
													</div>
                                              </div>
