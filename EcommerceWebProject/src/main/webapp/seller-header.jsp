              ...
              <div class="top"> <!-- top -->
                  <div class="container">
                      <ul class="top-support"> 
                          <li><i class="fa fa-phone-square"></i><span>(+91) 9427866544</span></li>
                          <li><a href=""><i class="fa fa-envelope-square"></i><span>admintest@gmail.com</span></a></li>
                      </ul>
                      ...
                      <div class="top-control">
                          ...
                          <%
                          	...
                          	{
                          %>
                          <a href="profile.jsp">Profile</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                          <a href="changePassword.jsp">Change Password</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                          <a href="logout.jsp">Logout(<%=u.getFname()%>)</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                          ...
                          <a href="register.jsp">Register</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                          <a href="login.jsp">Login</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
